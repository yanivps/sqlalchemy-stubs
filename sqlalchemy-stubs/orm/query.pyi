...
class Query(Generic[_T]):
    ...
    def add_entity(self: _Q, entity, alias: Optional[Any] = ...) -> _Q: ...
    def with_session(self: _Q, session: Optional[Session]) -> _Q: ...
    def from_self(self, *entities): ...
    def values(self, *columns): ...
    def value(self, column): ...
    def with_entities(self: _Q, *entities) -> _Q: ...
    def add_columns(self: _Q, *column) -> _Q: ...
    ...
    def execution_options(self: _Q, **kwargs) -> _Q: ...
    ...
    def union(self: _Q, *q) -> _Q: ...
    def union_all(self: _Q, *q) -> _Q: ...
    def intersect(self: _Q, *q) -> _Q: ...
    def intersect_all(self: _Q, *q) -> _Q: ...
    def except_(self: _Q, *q) -> _Q: ...
    ...
    # Custom extensions
    def unique_join(self: _Q, *props, **kwargs) -> _Q: ...
    def get_or_create(self: _Q, **kwargs) -> _T: ...
    def with_deleted(self: _Q) -> _Q: ...
